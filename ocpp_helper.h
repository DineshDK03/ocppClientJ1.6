...
ocpp_frame *formOCPPFrame(char *messagecode, char *actiontocms, char *messageid, cJSON *jsonpacket);
...
cJSON *MeterValuesRequest(int c_id, int t_id, char* timestamp, struct sampled_value);
